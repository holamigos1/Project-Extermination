...
public partial class @GameInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IFPSCharacterActions> m_FPSCharacterActionsCallbackInterfaces = new List<IFPSCharacterActions>();
    ...
    public struct FPSCharacterActions
    {
        ...
        public void AddCallbacks(IFPSCharacterActions instance)
        {
            if (instance == null || m_Wrapper.m_FPSCharacterActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_FPSCharacterActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IFPSCharacterActions instance)
        {
            @Moving.started -= instance.OnMoving;
            @Moving.performed -= instance.OnMoving;
            @Moving.canceled -= instance.OnMoving;
        ...
        public void RemoveCallbacks(IFPSCharacterActions instance)
        {
            if (m_Wrapper.m_FPSCharacterActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IFPSCharacterActions instance)
        {
            foreach (var item in m_Wrapper.m_FPSCharacterActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_FPSCharacterActionsCallbackInterfaces.Clear();
